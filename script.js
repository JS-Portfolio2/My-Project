...
lucide.createIcons();
// 2. منطق قائمة الموبايل (فتح وإغلاق عند الضغط في أي مكان)
...
if (menuBtn && mobileMenu) {
    ...
    menuBtn.addEventListener("click", (e) => {
        ...
        e.stopPropagation(); // منع انتشار الحدث لكي لا يغلق القائمة فوراً
    });

    // إغلاق القائمة عند الضغط على أي مكان في الشاشة
    document.addEventListener("click", (e) => {
        // التحقق من أن القائمة مفتوحة، وأن الضغط تم خارج القائمة وخارج زر الفتح نفسه
...
const translations = {
    ar: {
        ...
        btnDirect: "تواصل فوري", btnBrowse: "تصفح المشاريع ", btnContact: "تواصل معي الآن",
        ...
        heroDesc: "مرحباً بك في مساحتي الرقمية الخاصة. هنا أدمج شغفي بالهندسة وتطوير الأنظمة لبناء واجهات برمجية وتطبيقات متكاملة تتسم بالقوة والجمال مستوحاة من الدقة اللامتناهية.",
        ...
        // Rihla Platform Translation
        rihlaTitle: "منصة رِحلة لحجز القطارات",
        rihlaDesc: "منصة تفاعلية فاخرة لحجز الجولات والقطارات التاريخية. تدعم 4 لغات مع تبديل تلقائي كامل للاتجاهات (RTL/LTR)، لوحة حية للمغادرة، ونظام حجز مرن مع ميزة تأكيد التذاكر وتوليد الرقم المرجعي.",
        // Personal Portfolio Translation
        portfolioTitle: "الموقع التعريفي الشخصي",
        portfolioDesc: "موقع بورتفوليو احترافي ومستجيب بالكامل يعرض المهارات والخدمات والمشاريع البرمجية. يتميز بتصميم داكن وعصري مع تأثيرات حركية تفاعلية ونظام سلس للتنقل وعرض التفاصيل."
    },
    en: {
        ...
        // Rihla Platform Translation
        rihlaTitle: "Rihla — Train Booking Platform",
        rihlaDesc: "A premium interactive platform for booking historic train tours. Fully supports 4 languages with complete dynamic RTL/LTR layout flipping, live departure boards, and a validation-backed ticket confirmation system.",
        // Personal Portfolio Translation
        portfolioTitle: "Personal Portfolio Website",
        portfolioDesc: "A professional and fully responsive portfolio website highlighting developer skills, services, and featured projects. Built with a sleek dark-themed modern UI and interactive scroll features."
    },
    es: { 
        ...
        // Rihla Platform Translation
        rihlaTitle: "Rihla — Plataforma de Reserva de Trenes",
        rihlaDesc: "Una plataforma interactiva premium para reservar recorridos en trenes históricos. Soporta completamente 4 idiomas con cambio automático de diseño RTL/LTR, paneles de salida en vivo y un sistema flexible de confirmación de boletos.",
        // Personal Portfolio Translation
        portfolioTitle: "Sitio Web de Portafolio Personal",
        portfolioDesc: "Un sitio web de portafolio profesional y totalmente adaptable que destaca habilidades, servicios y proyectos. Diseñado con una interfaz moderna y oscura con efectos interactivos."
    },
    de: { 
        ...
        // Rihla Platform Translation
        rihlaTitle: "Rihla — Zugbuchungsplattform",
        rihlaDesc: "Eine erstklassige interaktive Plattform zur Buchung historischer Zugfahrten. Unterstützt vollständig 4 Sprachen mit dynamischer RTL/LTR-Layoutumschaltung, Live-Abfahrtstafeln und einem flexibben Ticketbestätigungssystem.",
        // Personal Portfolio Translation
        portfolioTitle: "Persönliche Portfolio-Website",
        portfolioDesc: "Eine professionelle und voll funktionsfähige Portfolio-Website, die Fähigkeiten, Dienstleistungen und Projekte hervorhebt. Entwickelt mit einer modernen Benutzeroberfläche im Dark-Mode."
    },
    tr: { 
        ...
        // Rihla Platform Translation
        rihlaTitle: "Rihla — Tren Rezervasyon Platformu",
        rihlaDesc: "Tarihi tren turları rezervasyonu için birinci sınıf interaktif bir platform. Dinamik RTL/LTR düzen geçişi, canlı kalkış panoları ve esnek bilet onay sistemi ile 4 dili tamamen destekler.",
        // Personal Portfolio Translation
        portfolioTitle: "Kişisel Portfolyo Web Sitesi",
        portfolioDesc: "Geliştirici becerilerini, hizmetlerini ve öne çıkan projelerini sergileyen profesyonel ve tamamen duyarlı bir portfolyo sitesi. Şık ve modern bir karanlık tema tasarımı ile üretilmiştir."
    },
    it: { 
        ...
        cPhone: "Numero di Telefono", cEmail: "Indirizzo Email", formName: "Nome", formEmail: "Email", formMsg: "Dettagli del Mensaje",
        ...
        // Rihla Platform Translation
        rihlaTitle: "Rihla — Piattaforma di Prenotazione Treni",
        rihlaDesc: "Una piattaforma interattiva premium per la prenotazione di tour su treni storici. Supporta completamente 4 lingue con commutazione dinamica del layout RTL/LTR, tabelloni delle partenze in tempo reale e un sistema di conferma dei biglietti.",
        // Personal Portfolio Translation
        portfolioTitle: "Sito Web di Portfolio Personale",
        portfolioDesc: "Un sito portfolio professionale e completamente reattivo che mette in evidenza competenze, servizi e progetti. Realizzato con un'interfaccia moderna in modalità scura ed elementi interattivi."
    }
};
...
function changeLanguage(lang) {
    ...
    // تحديث نصوص مشروع رِحلة ديناميكياً عند التبديل
    if(data.rihlaTitle && document.querySelector('[data-i18n="rihlaTitle"]')) document.querySelector('[data-i18n="rihlaTitle"]').textContent = data.rihlaTitle;
    if(data.rihlaDesc && document.querySelector('[data-i18n="rihlaDesc"]')) document.querySelector('[data-i18n="rihlaDesc"]').textContent = data.rihlaDesc;

    // تحديث نصوص مشروع البورتفوليو ديناميكياً عند التبديل
    if(data.portfolioTitle && document.querySelector('[data-i18n="portfolioTitle"]')) document.querySelector('[data-i18n="portfolioTitle"]').textContent = data.portfolioTitle;
    if(data.portfolioDesc && document.querySelector('[data-i18n="portfolioDesc"]')) document.querySelector('[data-i18n="portfolioDesc"]').textContent = data.portfolioDesc;
}
